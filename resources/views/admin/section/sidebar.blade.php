    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav  pt-lg-3">
                @role('branch')
                <li class="nav-item {{(Route::currentRouteName()=='branch.products')?'active':''}}">
                    <a class="nav-link  {{(Route::currentRouteName()=='branch.products')?'active':''}} " href="{{route('branch.products')}}">
